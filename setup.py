...
setup(
    ...
    install_requires=['numpy==1.26.1', 'matplotlib==3.8.0', 'scipy==1.11.3', 'scikit-learn==1.3.2', 'pandas==2.1.2', 'smartsifter==0.1.1.dev1', 'tqdm==4.66.1', 'openpyxl==3.2.0b1', 'pympler==1.0.1'],
